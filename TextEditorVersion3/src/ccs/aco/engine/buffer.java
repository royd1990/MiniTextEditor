...
public class buffer {
	 ...
	 * @param a String parameter to be inserted in the buffer
	 * @param x	Integer parameter determing the position of the caret.
	 */
	 ...
	 * @param substring String parameter giving the string to be inserted in the buffer.
	 * 
	 */
	...
	/**
	 * This method is used for internal delete operation within the buffer
	 */
	private void delete(){
		if(selStop!=0){
			this.cutSpecial();
	...
	/**
	 * This method is used internally by the buffer
	 */
